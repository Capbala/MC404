...
/*
Immediate Encoding Variants Shifts:
R Type: rd=7
        funct3=12
        rs1=15
        rs2=20
...
Binary representaion:
    ...
    0x3F    =                  11 1111 = 63
    0x7F    =                 111 1111 = 127
    0x3FF   =             11 1111 1111 = 1023
    0xFFF   =           1111 1111 1111 = 4095
    0xFFFFF = 1111 1111 1111 1111 1111 = 1048575

*/
int pack_data(InstData *data)
{
    int packed = 0;
    switch (data->type){
        case R:
            packed = (data->funct7 << 25) | (data->rs2 << 20) | (data->rs1 << 15) | (data->funct3 << 12) | (data->rd << 7) | (data->opcode);
            break;
        case I:
            packed = ((data->imm & 0xFFF) << 20) | (data->rs1 << 15) | (data->funct3 << 12) | (data->rd << 7) | (data->opcode);
            break;
        case S:
            packed = (((data->imm >> 5) & 0x7F) << 25) | (data->rs2 << 20) | (data->rs1 << 15) | (data->funct3 << 12) | ((data->imm & 0x1F) << 7) | (data->opcode);
            break;
        case B:
            packed = (((data->imm >> 12) & 0x1) << 31) | (((data->imm >> 5) & 0x3F) << 25) | (data->rs2 << 20) | (data->rs1 << 15) | (data->funct3 << 12) | (((data->imm >> 1) & 0xF) << 8) | (((data->imm >> 11) & 0x1) << 7) | (data->opcode);
            break;
        case U:
            packed = ((data->imm & 0xFFFFF) << 12) | (data->rd << 7) | (data->opcode);
            break;
        case J:
            packed = (((data->imm >> 20) & 0x1) << 31) | (((data->imm >> 1) & 0x3FF) << 21) | (((data->imm >> 11) & 0x1) << 20) | (((data->imm >> 12) & 0xFF) << 12) | (data->rd << 7) | (data->opcode);
            break;
    }
    return packed;
}
...
int main()
{
    ...
    read(STDIN_FD, buffer, 40);
    get_inst_data(buffer, &data);
    
    int packed = pack_data(&data);
    hex_code(packed);
